...
const movieConsturctor = (selector, options) => {
	...
	if (options.favicon) {
		const index = options.favicon.lastIndexOf('.'); //lastIndexOf находит точку в witcher/logo.png и вернет
